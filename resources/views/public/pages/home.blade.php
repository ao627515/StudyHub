        ...
        <div class="container pt-7 pt-md-11 pb-8">
            <div class="row gx-0 gy-10 align-items-center">
                <div class="col-lg-6" data-cues="slideInDown" data-group="page-title" data-delay="600">
                    ...
                    <p class="lead fs-24 lh-sm text-white mb-7 pe-md-18 pe-lg-0 pe-xxl-15">We carefully consider
        ...
        <div class="container pt-19 pt-md-21 pb-16 pb-md-18">
            ...
            <div class="row gx-md-8 gy-8 mb-14 mb-md-18">
                <div class="col-md-6 col-lg-3">
                    ...
                    <h4>24/7 Support</h4>
                    <p class="mb-3">Nulla vitae elit libero, a pharetra augue. Donec id elit non mi porta gravida
        ...
        <div class="container py-18">
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <h3 class="display-4 mb-6 text-white pe-xxl-18">We are trusted by over 5000+ clients. Join them
                        by using our services and grow your business.</h3>
        ...
        <div class="container py-14 py-md-16">
            <div class="row">
                <div class="col-lg-9 col-xl-8 col-xxl-7">
                    ...
                    <h3 class="display-4 mb-9">Check out some of our awesome projects with creative ideas and great
                        design.</h3>
                </div>
                <!-- /column -->
            </div>
        ...
        <div class="container py-16 py-md-18 position-relative">
            ...
            <div class="row gy-6 mb-16 mb-md-18">
                <div class="col-lg-4">
                    ...
                    <p>Enjoy a <a href="#" class="hover">free 30-day trial</a> and experience the full
                        service. No credit card required!</p>
                        ...
                        <div class="col-md-6 popular">
                            <div class="pricing card shadow-lg">
                                <div class="card-body pb-12">
                                    ...
                                    <ul class="icon-list bullet-bg bullet-soft-primary mt-7 mb-8">
                                        <li><i class="uil uil-check"></i><span><strong>20</strong> Projects
                                            </span></li>
